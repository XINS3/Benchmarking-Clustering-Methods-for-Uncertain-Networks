...
importlib.reload(load_graph)
gmm_clustering={}
path1='mcp_acp_data//krogan2006_core//intersec_mips//mcpc_results//'
...
pre_gmm_v1 = list(clustering_df['center']) #add by xin
'''
...
for row in data["tables"]["clustering"]:
    ...
    clusters[str(row["center label"])].append(int(row["label"])) #add by xin
